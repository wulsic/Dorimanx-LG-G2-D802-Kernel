...
static void mddi_ext_early_suspend(struct power_suspend *h);
static void mddi_ext_early_resume(struct power_suspend *h);
#endif
...
static int mddi_ext_probe(struct platform_device *pdev)
{
	...
	register_power_suspend(&mfd->mddi_ext_early_suspend);
#endif
