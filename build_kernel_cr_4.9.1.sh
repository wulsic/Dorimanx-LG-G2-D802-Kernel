...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	./mkbootimg --cmdline 'console=null androidboot.hardware=qcom user_debug=31 maxcpus=4 zcache' --kernel $PACKAGEDIR/zImage --ramdisk $PACKAGEDIR/ramdisk.gz --base 0x80200000 --pagesize 2048 --ramdisk_offset 0x02000000 --output $PACKAGEDIR/boot.img
	cd $PACKAGEDIR
